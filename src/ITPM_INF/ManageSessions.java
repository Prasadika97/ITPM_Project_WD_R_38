  ...
  public void sessiontwo(){
   ...
   public void tableloadpar(){
    ...
    private void initComponents() {
        ...
        btnconsecut.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnconsecutActionPerformed(evt);
            }
        });
        ...
        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, 1790, 330));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        this.toBack();
        ViewConsecutive newFrame = new ViewConsecutive();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
         ...
         this.toBack();
        ViewParalle newFrame = new ViewParalle();
        newFrame.setVisible(true);
        newFrame.toFront();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        this.toBack();
        ViewNonOverlapping newFrame = new ViewNonOverlapping();
        newFrame.setVisible(true);
        newFrame.toFront();
    ...
    private void btnconsecutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnconsecutActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnconsecutActionPerformed
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      ...
      this.toBack();
       NotAvailableTimes newFrame = new NotAvailableTimes();
        newFrame.setVisible(true);
        newFrame.toFront();
